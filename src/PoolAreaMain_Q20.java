/* 20 The Swimming Company has asked you to write an application that calculates the volume of cuboid
shaped pools.
...
public class PoolAreaMain_Q20 {
    ...
    }//Consists of 2 methods Cuboid and Rectangle
}
